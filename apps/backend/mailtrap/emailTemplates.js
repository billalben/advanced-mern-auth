    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background-color: #f9f9f9; padding: 20px;">
        ...
        <p>
          ...
          This code will expire in <strong>1 hour</strong> for security reasons. <br />
...
export const PASSWORD_RESET_REQUEST_TEMPLATE = (resetURL = "ERROR") => {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
      <div style="background: linear-gradient(to right, #4CAF50, #38863c); padding: 20px; text-align: center;">
        <h1 style="color: white; margin: 0; letter-spacing: 3px;">Password Reset</h1>
      </div>
      <div style="background-color: #f9f9f9; padding: 20px;">
        <p>
          Hello, <br />
        ...
        <div style="text-align: center; margin: 52px 0;">
          <a href="${resetURL}" style="background-color: #4CAF50; color: white; padding: 12px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">Reset Password</a>
        </div>
        <p>
          This link will expire in <strong>30 minutes</strong> for security reasons. <br />
...
/**
  * Template for a successful password reset email.
 * @returns {string} - The email template for a successful password reset.
 */
