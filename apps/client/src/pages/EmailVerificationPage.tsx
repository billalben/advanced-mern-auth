    ...
    <div className="w-full max-w-md overflow-hidden bg-gray-800 bg-opacity-50 shadow-xl rounded-2xl backdrop-blur-xl backdrop-filter">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {errorMessage && (
            <p className="my-2 font-semibold text-red-500">{errorMessage}</p>
          )}
          <motion.button
            ...
            className="w-full px-4 py-3 font-bold text-white rounded-lg shadow-lg bg-linear-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 disabled:opacity-50"
          >
